									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="mobileNo" name="mobileNo"
												value="${CustomerDetails.mobileNo}" disabled>
										</div>
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="altContactNo" name="altContactNo"
												value="${CustomerDetails.altContactNo}" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="email" class="form-control" id="email" name="email"
												value="${CustomerDetails.email}" disabled>
										</div>
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="companyName" name="companyName"
												value="${CustomerDetails.companyName}" disabled>
										</div>
										</div>
										<div class="form-group">
