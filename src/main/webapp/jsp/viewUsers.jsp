...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<div class="box-body box-primary" style="overflow: scroll;">
									...
									<tbody>
										<c:forEach items="${userList}" var="userList">
											<tr>
												...
												<td>
												<a href="viewUser/${userList.id}/" class="btn btn-success btn-xs"> View <i class="fa fa-search-plus"></i></a> 
												<a href="editUser/${userList.id}/" class="btn btn-info btn-xs">Edit <i class="fa fa-edit"></i></a>
												<a class="btn btn-danger btn-xs modelLink" data-toggle="modal" data-target="#modal-danger" data-id="${userList.id}"> Delete <i class="fa fa-remove"></i></a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
	...
	<script>
    	...
    	$.ajax({url:"viewUsers",
    			...
    			success:
    			function(data){
        		$(".confirm").attr('href',"deleteUser/"+dataId+"/")
